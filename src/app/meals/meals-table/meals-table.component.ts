...
const ELEMENT_DATA: Element[] = [
  ...
  {name: 'Ryba  z ziołami', calories: 900, carbohydrates: 15, protein: 40, fats: 55, kind: 'dinners', taste: 'salty'},
  {name: 'Owsianka z owocami', calories: 300, carbohydrates: 45, protein: 7, fats: 5, kind: 'breakfasts', taste: 'sweet'},
  ...
  {name: 'Kurczak duszony', calories: 1100, carbohydrates: 30, protein: 45, fats: 50, kind: 'dinners', taste: 'salty'},
  ...
  {name: 'Kasza z warzywami', calories: 600, carbohydrates: 50, protein: 12, fats: 20, kind: 'dinners', taste: 'salty'},
  {name: 'Jogurt malinowy', calories: 230, carbohydrates: 20, protein: 12, fats: 10, kind: 'snacks', taste: 'sweet'},
  {name: 'Chleb  z serem', calories: 450, carbohydrates: 30, protein: 15, fats: 20, kind: 'snacks', taste: 'salty'},
  ...
  {name: 'Musli z owocami', calories: 280, carbohydrates: 35, protein: 6, fats: 8, kind: 'snacks', taste: 'sweet'},

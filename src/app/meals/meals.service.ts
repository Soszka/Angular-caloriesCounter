...
export class MealsService {
  ...
  private elementsData: MealElement[] = [
    ...
    { id: 9, name: 'Jabłko', calories: 54, carbohydrates: 54, protein: 1, fats: 1, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 14, name: 'Pomarańcz', calories: 65, carbohydrates: 13, protein: 1, fats: 1, kind: 'fruits-vegetables', taste: 'sweet' },
    ...
    { id: 26, name: 'Pieczone ziemniaki', calories: 500, carbohydrates: 40, protein: 5, fats: 25, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 32, name: 'Sałatka z rukolą', calories: 300, carbohydrates: 10, protein: 5, fats: 25, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 47, name: 'Koktajl mandarynkowy', calories: 300, carbohydrates: 35, protein: 7, fats: 5, kind: 'fruits-vegetables', taste: 'sweet' },
    { id: 48, name: 'Sałatka z selera', calories: 240, carbohydrates: 15, protein: 10, fats: 18, kind: 'snacks', taste: 'salty' },
    { id: 49, name: 'Kanapki z avocado', calories: 420, carbohydrates: 25, protein: 10, fats: 30, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 65, name: 'Sałatka warzywna', calories: 638, carbohydrates: 64, protein: 28, fats: 30, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 71, name: 'Sałatka owocowa', calories: 346, carbohydrates: 75, protein: 7, fats: 2, kind: 'fruits-vegetables', taste: 'salty' },
    ...
    { id: 80, name: 'Banan', calories: 93, carbohydrates: 20, protein: 1, fats: 1, kind: 'fruits-vegetables', taste: 'salty' },
    { id: 81, name: 'Kanapki z pastą jajeczną', calories: 450, carbohydrates: 30, protein: 15, fats: 25, kind: 'snacks', taste: 'salty' },
    { id: 82, name: 'Koktajl kiwi', calories: 290, carbohydrates: 40, protein: 7, fats: 5, kind: 'fruits-vegetables', taste: 'sweet' },
    ...
    { id: 85, name: 'Orzechy', calories: 370, carbohydrates: 9, protein: 16, fats: 30, kind: 'fruits-vegetables', taste: 'sweet' },
    ...
    { id: 93, name: 'Cytryna', calories: 61, carbohydrates: 12, protein: 1, fats: 1, kind: 'fruits-vegetables', taste: 'salty' },
    { id: 94, name: 'Koktajl z mango', calories: 310, carbohydrates: 45, protein: 7, fats: 5, kind: 'fruits-vegetables', taste: 'sweet' },
